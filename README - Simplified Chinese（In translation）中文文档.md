...
Netdata 加入了[Cloud Native Computing Foundation (CNCF) 云原生计算基金会](https://landscape.cncf.io/grouping=no&sort=stars)，
具体请查看[CNCF TOC Netdata 演示文档](https://docs.google.com/presentation/d/18C8bCTbtgKDWqPa57GXIjB2PbjjpjsUNkLtZEz6YK8s/edit?usp=sharing).  

---

大家都**沉迷于使用netdata**.<br/>
一旦你在你的系统上使用过它, **就再也回不去了**! *老司机们都是这么告诉我们的...*
...
1. [它是什么样儿的](#how-it-looks) - 来看看这个迷人的小东西
2. [用户群体](#user-base) - 哪些人需要netdata?
3. [快速开始](#quick-start) - 赶紧来试试吧！
4. [为什么选择Netdata](#why-netdata) - 为什么大家都喜欢netdata, 它与其他的解决方案有哪些不同
5. [News](#news) - 关于netdata的一些新变化
6. [它是怎么运行的](#how-it-works) - 关于netdata运行的深度图解
7. [资料](#infographic) - 关于netdata的一图说明
8. [特点](#features) - 它有哪些特点
9. [可视化](#visualization) - 独特的可视化功能
10. [它监控什么](#what-does-it-monitor) - 它收集哪些指标
11. [文档](#documentation) - 查阅文档信息
12. [社区](#community) - 跟老司机们聊聊并获得支持
13. [License](#license) - 查看netdata的License文件
14. [对你有好处么](#is-it-any-good) - 废话
15. [屌不屌](#is-it-awesome) - 屌屌屌！
